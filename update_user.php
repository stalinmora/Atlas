        ...
        <![endif]-->
         <div class="signin-form">
            ...
            <div class="container" style="width: 330px;">
                ...
                <form action="login_update.php" class="form-signin" method="post" id="login-form">

                    <h2 align="center" class="form-signin-heading">Cambio de Clave.</h2><hr />
                    ...
                    <div class="form-group">
                        <input type="password" class="form-control" placeholder="Re Password" name="repassword" id="repassword" />
                    </div>
